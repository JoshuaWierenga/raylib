/* Keyboard handling functions for DJGPP v2.00, by Martynas Kunigelis 1996 */
...
#define SCAN_EXT_OFT (SCAN_EXT_PREFIX << 8)
#define SCAN_EXT_KP_ENTER 0x1C
#define SCAN_EXT_PRINT_SCREEN 0x2A // Ignoring 0x37
#define SCAN_EXT_LGUI 0x5B
#define SCAN_EXT_RGUI 0x5C
